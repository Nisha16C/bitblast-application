...
bitblast_ip = os.getenv('BITBLAST_IP')

ALLOWED_HOSTS = [bitblast_ip,'127.0.0.1', 'localhost', '172.16.1.190']
...
ASGI_APPLICATION = 'DBaas_project.asgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'role_assignment_file': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': 'logs/user-role.log',
            'formatter': 'verbose',
        },
        'Grouprole_assignment_file': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': 'logs/group-role.log',
            'formatter': 'verbose',
        },
        'rename_project_file': {
            'level': 'INFO',
    ...
    'loggers': {
        ...
        'Grouprole_assignment_logger': {
            'handlers': ['Grouprole_assignment_file'],
            'level': 'INFO',
            'propagate': True,
        },
