    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div class="" :class="this.$store.state.isRTL ? 'float-end' : 'float-start'">
          <h5 class="mt-3 mb-0">BitBlast Configurator</h5>
        </div>
...
export default {
  ...
  methods: {
    ...
    sidenavTypeOnResize() {
      ...
      if (white) { // Check if white is not null
        ...
        console.warn("Element with ID 'btn-white' not found.");
      }
    }
  },
  computed: {
  ...
  mounted() {
    this.sidenavTypeOnResize(); // Call it after component mounts
